...
<body style="background-color: #ebeff4">
    ...
    <div class="row mb-7  ms-3">
        ...
        <section id="sidebar"
            class="col-9 col-md-3 me-0 me-md-5 ps-5 pt-5 pb-3 bg-light shadow h-100 mt-5 rounded rounded-3">
            <h2>Courses</h2>
        ...
        {
            $result = $playlist->search($_POST['search']);
        ...
        {
            echo '<p class="text-center fs-4 mt-5">No Courses found!</p>';
        }   
    }
    else
    {
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-6">
                                        ...
                                        <a class="text-dark"
                                            href="profile_view.php?user_id=<?= $fetch_playlist['user_id'] ?>"
                                            style="font-size: 13px;"><?= $fetch_playlist['user_name'] ?></a>
                                    ...
                                    <div class="col-md-6 col-lg-3 col-xl-3 border-sm-start-none border-start">
                                        ...
                                        <div class="d-flex flex-column mt-4">
                                            ...
                                            <a class="btn btn-secondary btn-sm mt-2"
                                                href="View-Course.php?playlist_id=<?= $fetch_playlist['playlist_id'] ?>">
                                                View Courses
                                            </a>
                                        </div>
                                    </div>
