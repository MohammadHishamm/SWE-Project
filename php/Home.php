                                ...
                                <div class="row mb-3">
                                    <div class="col-7 d-flex justify-content-start align-items-center">
                                        <img src="../Images/avatar-2.webp" alt="Generic placeholder image"
                                            ...
                                            style="width: 40px;">
                                        <a class="ps-2" href="profile_view.php?user_id=15"
                                            style="font-size: 13px;">@zayaty750</a>
                                    </div>
        ...
        <div class="row  align-items-center g-5 py-5">
            ...
            <div class="col-lg-6 p-5">
                ...
                <h1>
                    ...
                    <p class="fs-6 lead">Quickly design and customize responsive mobile-first sites with Bootstrap, the
