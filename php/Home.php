...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary ">
    <div class="container-fluid">
      ...
      <a class="text navbar-brand mx-auto mb-lg-0 mb-3" href="#" style=" font-size: 30px; font-weight: bolder;">Arab Data Hub</a>
  ...
  <div class="container col-xxl-8 px-4 py-5" >
    <div class="row  align-items-center g-5 py-5" >
      <div class="col-10 col-sm-8 col-lg-6">
        <img src="../Images/hero 1 back image.avif" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy">
      </div>

      <div class="col-lg-6 p-5">

        <p class="fs-6 fw-bold lh-1 " style="color: #58779D;">ABOUT US<h1>
        <h1 class="fs-2 fw-bold lh-1 mb-3" style="color: black;">Innovative Way To Learn</h1>
        <p class="fs-6 lead">Quickly design and customize responsive mobile-first sites with Bootstrap, the world’s most popular front-end open source toolkit, featuring Sass variables and mixins, responsive grid system, extensive prebuilt components, and powerful JavaScript plugins.</p>
        <div class="d-grid gap-2 d-md-flex justify-content-md-start">
          <button type="button" class="btn btn-primary btn-lg px-4 me-md-2" style="background-color: #58779D; color: white;">Learn More</button>
        </div>
      </div>
