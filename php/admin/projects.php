  ...
  <div class="page d-flex">
    <div class="sidebar bg-white p-20 p-relative">
      ...
      <ul>
        ...
        <li>
          <a class="active d-flex align-center fs-14 c-black rad-6 p-10" href="projects.php">
    ...
    <div class="content w-full">
      ...
      <div class="projects-page d-grid m-20 gap-20">
        <div class="project bg-white p-20 rad-6 p-relative">
          ...
          <h4 class="m-0">Arab Data Hub Dashboard</h4>
          <p class="c-grey mt-10 mb-10 fs-14">Arab Data Hub Dashboard Project Design And Programming And Hosting</p>
          <div class="team">
